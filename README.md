...
| **XGBoost** **Best Performer**.| Best recall and highest AUC overall; very accurate and efficient with tuning, though more complex to interpret and tune compared to simpler models.|
